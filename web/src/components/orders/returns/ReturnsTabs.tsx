...
import { statusTabs, type ReturnBucket } from "@/lib/returns-data";

export default function ReturnsTabs({ active, onChange }: { active: ReturnBucket; onChange: (key: ReturnBucket) => void }) {
  return (
